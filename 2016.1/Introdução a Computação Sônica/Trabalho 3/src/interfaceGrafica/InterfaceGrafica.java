...
public class InterfaceGrafica implements	ActionListener, ChangeListener, ItemListener,
	...
	/**
	 * Criacao da interface grafica para componentes externos,
	 * de maneira estatica
	 */
	...
	private void constroiAbMelodias (){
			...
			melodiasDisponiveis.add("gameOfThrones");
			melodiasDisponiveis.add("rainsOfCastamere");
			melodiasDisponiveis.add("melodiasexta1");
			melodiasDisponiveis.add("sonata_scarlatti");
			melodiasDisponiveis.add("tema_aa_drawing_quintet_flauta");
			melodiasDisponiveis.add("tema_aa_fuga1");
			melodiasDisponiveis.add("tema_bwv775_invencao14_direita");
			melodiasDisponiveis.add("tema_bwv775_invencao4_direita");
			melodiasDisponiveis.add("tema_bwv775_invencao4_esquerda");
