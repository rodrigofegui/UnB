 ...
 *          - 10 (H) / 30 (L)
 *          - 120 (H) / 200 (L)
 *      respectivamente. Tempo em milisegundos.
 *****************************************************************/
/*****************************************************************
...
/*  Para o SMCLK de 1Mhz, 1ms = 2^20 * 10^-3 */
#define PASSO_1MS (int)(1048576 * 0.001)
/*  MDC{10, 30, 120, 200} = 10 */
#define PASSO_COMUM (10 * PASSO_1MS)
