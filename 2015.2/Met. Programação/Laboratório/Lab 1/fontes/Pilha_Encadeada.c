...
void insere_pilha_enc (Pilha *pilha, int info){
...
Elemento * retira_pilha_enc (Pilha *pilha){
    if (vazia_enc(pilha) == VAZIA){
...
void libera_pilha (Pilha *pilha){
    while (pilha->topo != NULL){
        Elemento *aux = retira_pilha_enc (pilha);
