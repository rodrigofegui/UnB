...
/*  Caso não tenha sido declarada na tabela de símbolos */
    ...
    ********************************************************/
		...
		typedef struct adp{
			char nome[50];
			int lin_i, col_i,entrada;/*!< entrada eh a energia que entra no adaptador*/
    ...
    ********************************************************/
		...
		typedef struct intercon{
			...
			int status;/*!< Vai registrar se o elemento de interconexao foi verificado. */
			struct intercon *prox_i;
			City *prox_c,*ant_c;
