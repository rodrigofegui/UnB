...
*****************************************************************/
    ...
    FILE * arq_abre (string nome, string modo, char extra){
        ...
        **  leitura ou escrita; 'auxiliar' armazena o arquivo lógico a ser manipulado */
        ...
        auxiliar = fopen (nome.c_str(), modo.c_str());
    ...
    **	e quantidade de caracteres a serem comparados */
    int string_compara_n (string palavra1, string palavra2, int inicio1, int inicio2, int quant){
    ...
    void string_concat_n (string destino, string fonte, int iniciof, int fimf){
