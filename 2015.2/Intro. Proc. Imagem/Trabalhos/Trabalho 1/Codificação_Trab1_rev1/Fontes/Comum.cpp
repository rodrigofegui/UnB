...
#include "../Bibliotecas/Comum.hpp"


/*  Definições da funções a serem manipuladas por este arquivo */
...
char inicio_geral (){
    ...
    limpa_tela();
    printf ("Bem-vindo ao processamento de imagens!\n");
    printf ("Este projeto tem o nome de:\n\n");
    printf ("\tDeteccao de Componentes Conectados e Classificacao de Imagens\n\n");
    printf ("Este projeto tem por objetivos:\n");
    printf ("\t1. Binarizacao de imagens, em relacao a cor de pele;\n");
    printf ("\t2. Detectar as regioes, pelos elementos conectados;\n");
    printf ("\t3. Determinar a maior regiao, dentre as detectadas;\n");
    printf ("\t4. Classificar as imagens de analise em duas classes:\n");
    printf ("\t\tClasse 1: maior parte do corpo descoberta;\n");
    printf ("\t\tClasse 2: maior parte do corpo coberta.\n");
    printf ("\t5. Calculo da F-Measure para esta classificacao.\n");
...
/*  Função 'n_ultima_ocorrencia', descobre a n-última ocorrencia de um caracter numa string */
int n_ultima_ocorrencia (char *avaliar, char alvo, int quant){
...
/*  Funçao 'pausa', realiza a pausa do programa ate pressionar o ENTER */
void pausa (){
...
int string_compara_n (char *palavra1, std::string palavra2, int inicio1, int inicio2, int quant){
	...
	**	strings */
    ...
    for (int ind1 = inicio1; ind1 < (inicio1 + quant); ind1++){
