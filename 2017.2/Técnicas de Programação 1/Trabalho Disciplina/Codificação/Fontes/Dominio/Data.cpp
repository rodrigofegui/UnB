...
void Data::deletar() {delete this;}

void Data::validar (const string &campo) throw (invalid_argument){
...
void Data::validarTamanho (const string &campo) throw (invalid_argument){
    if(!Manipulacao::tam(campo, DATA_TAM))
        throw invalid_argument (msgErroTam);
}

void Data::validarFormato (const string &campo) throw (invalid_argument){
    if((campo.at(DIVISAO_1) != DIVISOR)
       || (campo.at(DIVISAO_2) != DIVISOR))
        throw invalid_argument (msgErroArg);
}

void Data::validarDia (const string &campo) throw (invalid_argument){
...
void Data::validarMes (const string &campo) throw (invalid_argument){
...
void Data::validarAno (const string &campo) throw (invalid_argument){
...
void Data::validarData () throw (invalid_argument){
...
void Data::validarFevereiro () throw (invalid_argument){
